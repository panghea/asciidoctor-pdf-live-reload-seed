...
asciidoctor -o ($file -replace ".adoc",".pdf") -a "pdf-fontsdir=fonts" -a "pdf-stylesdir=pdf-style" -a "pdf-style=basic-theme.yml" -b pdf  -a toc  -r asciidoctor-pdf -d book -a "data-uri!" -a "source-highlighter=rouge" -r asciidoctor-diagram  $file
